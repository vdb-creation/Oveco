    ...
    collections: [
            ...
            templates: [
              ...
              // PROJECTS
              {
                ...
                fields: [
                  ...
                  // Les cartes sont maintenant générées automatiquement depuis les projets créés
            ...
            templates: [
              ...
              // PROJECTS
              {
                ...
                fields: [
                  ...
                  // Project cards are now automatically generated from created projects
                  // No need to add them manually anymore
                ],
              },
      ...
      // ==================== TESTIMONIALS ====================
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            ui: {
              description: "Identifiant unique pour l'URL (ex: temoignage-client-martin)",
            },
          },
          {
            type: "string",
          ...
          imageField("thumbnail", "Photo du client", "team"),
          imageField("backgroundImage", "Image de fond", "hero"),
          {
            type: "string",
            name: "linkedProjectSlug",
            label: "Projet lié",
            ui: {
              description: "Slug du projet associé à ce témoignage",
            },
          },
          {
            type: "string",
      ...
      // ==================== PROJETS ====================
      {
        ...
        fields: [
          ...
          // Tags (pour organisation interne, n'apparaissent pas sur la page)
          {
            type: "string",
            name: "tags",
            label: "Tags",
          ...
          // Sections spécifiques au projet (optionnelles)
          {
            type: "object",
            name: "competences",
            ...
            ui: {
              itemProps: (item: any) => {
                return { label: item?.title || 'Compétence' };
              },
            } as any,
          },
          
          {
            ...
            ui: {
              itemProps: (item: any) => {
                return { label: `${item?.value || '0'} ${item?.unit || ''} - ${item?.label || 'Statistique'}` };
              },
            } as any,
          },
